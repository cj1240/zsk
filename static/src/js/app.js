...
/*global angular*/
window.ccs = true;
angular.module('ccs', ['ngAnimate', 'ccs.tools', 'ccs.router', 'ccs.filters', 'ccs.services', 'ccs.locale', 'ccs.directives', 'ccs.controllers']).
config(['$httpProvider', 'app',
    ...
    function (app, $q, $rootScope, $location, $timeout, $filter, $locale,
        ...
        function resize() {
            var viewWidth = global.viewWidth = ccsWin.width();
            global.viewHeight = ccsWin.height();
        ...
        angular.extend(app, tools); //添加ccs系列工具函数
        ...
        app.checkUser = function () {
            ...
            global.isEditor = global.user && global.user.role >= 1;
        };
        ...
        ccsWin.resize(applyFn.bind(null, resize));
