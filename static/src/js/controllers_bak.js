...
angular.module('ccs.controllers', ['ui.validate']).
controller('indexCtrl', ['app', '$scope', '$routeParams', 'getList',
    ...
    function (app, $scope) {
        ...
        <!--$scope.parent = {
            getTpl: app.getFile.html('cxjg.html')
        };-->
            ...
            $scope.phones = [
                ...
                },
                {
                    ...
                    "name": "Samsung Gem?",
                    "snippet": "The Samsung Gem? brings you everything that you would expect and more from a touch display smart phone �C more apps, more features and a more affordable price."
                },
                {
                    "age": 6 ,
                    "id": "Dell Venue",
                    "imageUrl": "/static/Images/p6.jpg",
                    "name": "Dell Venue",
...

                {
                    "age": 10 ,
                    "id": "Samsung Showcase?",
                    "imageUrl": "/static/Images/p10.jpg",
                ...
                },
                {
                    "age": 11 ,
                    "id": "DROID? 2",
                    "imageUrl": "/static/Images/p11.jpg",
                ...
                },
                {
                    "age": 12 ,
                    "id": "DROID?",
                    "imageUrl": "/static/Images/p12.jpg",
                ...
                },
                {
                    "age": 13 ,
                    "id": "MOTOROLA BRAVO?",
                    "imageUrl": "/static/Images/p13.jpg",
                ...
                },
                {
                    ...
                    "imageUrl": "/static/Images/p14.jpg",
                ...
                },
                {
                    ...
                    "imageUrl": "/static/Images/p15.jpg",
                    "name": "T-Mobile myTouch 4G",
                    "snippet": "e T-Mobile myTouch 4G is a premium smartphone designed to deliver blazing fast 4G speeds so that you can video chat from practically anywhere, with or without Wi-Fi."
                },
                {
                    "age": 16 ,
                    "id": "Samsung Mesmerize?",
                    "imageUrl": "/static/Images/p16.jpg",
                ...
                },
                {
                    "age": 17 ,
                    "id": "SANYO ZIO",
                    "imageUrl": "/static/Images/p17.jpg",
                    "name": "SANYO ZIO",
                ...
                },
                {
                    ...
                    "imageUrl": "/static/Images/p18.jpg",
                ...
                },
                {
                    "age": 19 ,
                    "id": "T-Mobile G2",
                    "imageUrl": "/static/Images/p19.jpg",
                    "name": "T-Mobile G2",
...

                {
                    ...
                    "imageUrl": "/static/Images/p20.jpg",
    ...
    function (app, $scope, $routeParams) {
        ...
        //app.toast.info($scope.parent.getTpl);//dw2014
    }
        ...
        function getArticleList() {
            ...
            app.promiseGet(params, restAPI, app.param(params), app.cache.list).then(function (data) {
                ...
                if (!$routeParams.ID) {
                    ...
                    $scope.parent.title = "登陆时间: " + app.filter('date')(data.readtimestamp, 'medium');
                } else {
                    $scope.parent.title = data.user.name + locale.USER[params.OP];
                }
                $scope.articleList = data.data;
    ...
    function (app, $scope, $routeParams) {
        ...
        $scope.reset = function () {
            //$scope.userList = app.union(originData);
                $scope.test = app.union(null);//dw2014
        };
        $scope.submit = function () {

            app.toast.info("aaaaaa");//dw2014

            if (app.validate($scope)) {
                var data = app.union($scope.test);

                app.toast.info("[" + data.a + "][" + data.b +"]["+ data.c + "]");
            ...
            //app.toast.info("[" + $scope.user.id + "][" + $scope.user.name +"]["+ $scope.user.zjh + "]");
        };
    }
...
]).controller('UserInputCtrl', ['app', '$scope', '$routeParams',
        //dw2014
        function (app, $scope, $routeParams) {
            var originData = {},
                restAPI = app.restAPI.test,
                myConf = app.myConf,
                testList = [{
                    _id: '',
                    a: '',
                ...
                params = {
                    ID: 'add',
                    p: $routeParams.p,
                    s: $routeParams.s || myConf.pageSize(null, 'test', 20)
                };
            $scope.test = {
                _id: 0,
                a: '',
            ...
            app.toast.info(params.p);//dw2014
            app.toast.info(params.s);//dw2014
            app.toast.info(params.id);//dw2014


            function inittestList(list) {
                originData = app.union(app.union(testList), list);
                $scope.testList = app.union(originData);
                $scope.parent.editSave = !! app.checkDirty(testList, originData, $scope.testList);
            }
            $scope.parent = {
                editSave: false
            };
            $scope.pagination = {};
            /*$scope.testList= [
                { a: '男丁格尔', b: 18,c: 'aaa',d: 'bbb' },
                { a: 'jelly', b: 16,c: 'aaa',d: 'bbb'  },
                { a: '梅干桑', b: 30,c: 'aaa',d: 'bbb'  },
                { a: '莫希尔', b: 31,c: 'aaa',d: 'bbb'  }
            ];*/
            ...
            $scope.$watch('testList', function (value) {
                $scope.parent.editSave = !! app.checkDirty(testList, originData, value);
            }, true);
                app.promiseGet(params, restAPI).then(function (data) {
                /*var pagination = data.pagination || {};
                pagination.path = app.location.path();
